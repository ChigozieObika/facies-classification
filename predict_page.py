...
def make_bar_charts(logs, min_depth, max_depth):
    ...
    data_chart.rename(columns={'index':'Facies', 'Facies':'Counts'}, inplace=True)
    ...
    ax[1].pie(
        data_chart.Counts, colors = data_colors, labels = labels, autopct='%1.1f%%', pctdistance=0.85,
        )
